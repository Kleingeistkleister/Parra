...
# Class to handle trigger synchronization
class MCU_trsync:
    ...
    def _build_config(self):
        try:
            ...
            print(f"Error in _build_config: {e}")
    ...
    def _handle_trsync_state(self, params):
        try:
            ...
            print(f"Error in _handle_trsync_state: {e}")
    ...
    def set_home_end_time(self, home_end_time):
        try:
            ...
            print(f"Error in set_home_end_time: {e}")
...
# Class to handle trigger dispatch
...
def add_printer_objects(config):
    ...
    # Add a sync object for the main MCU
    # This object will be used to synchronize the main MCU and
    # all secondary MCUs
