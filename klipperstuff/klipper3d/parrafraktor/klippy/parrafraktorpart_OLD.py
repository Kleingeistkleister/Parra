## Code for coordinating events on the printer parrafraktor_part
#
# Copyright (C) 2016-2024  Kevin O'Connor <kevin@koconnor.net>
#
# This file may be distributed under the terms of the GNU GPLv3 license.
import math, logging, importlib , queue
import mcu, chelper
...
# Main code to track events (and their timing) on the printer parrafraktor_part
class ParrafraktorPart:
...
# The main loop of the toolhead is to process queued moves.  The
# toolhead maintains a "look-ahead" queue of moves to reduce the
# acceleration between moves.  The toolhead also tracks the current
# print time and ensures the print time is kept in sync with the
# estimated print time of the MCU.
...
def add_printer_objects(config):
    config.get_printer().add_object('parrafraktor_part', ParrafraktorPart(config))
